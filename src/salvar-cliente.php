/*
Arquivo: salvar-cliente.php
Local original: /mnt/data/avaliacao_repositorio/original/salvar-cliente.php
...
switch ($_REQUEST['acao']) {
    ...
    case 'editar':
        ...
        $sql = "UPDATE cliente SET nome_cliente='{$nome}', cpf_cliente='{$cpf}', telefone_cliente='{$telefone}', email_cliente='{$email}', endereco_cliente='{$endereco}' WHERE id_cliente=".$_REQUEST['id_cliente'];
